use crate::{
    ...
    ConversationCompactionError, EchoError, EgoError, EntityError, GraphError, InsomniaError,
    MemoryError, MemoryVectorError, PackedVectorError, RelationshipError, VectorGenerationError,
};
use std::fmt;
