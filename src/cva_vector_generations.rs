use crate::embedding_profile_probe::{validate_embedding_batch, verify_endpoint};
use crate::vector_generation_validation::{validate_generation_reference, vector_generation_id};
use crate::{
    Cva, EmbeddingEndpoint, EmbeddingMode, EmbeddingProfileId, PackedVectors, ScalarType,
...
impl Cva {
    pub fn build_archive_vector_generation(
        ...
        let mut bytes = Vec::with_capacity(vectors.len() * profile.dimensions as usize * 4);
        ...
        self.publish_vector_generation(profile_id, archive_vector_id, source_archive_version)
    }
    ...
    pub fn publish_vector_generation(
        ...
        let candidate = VectorGeneration {
            id: vector_generation_id(profile_id, archive_vector_id, source_archive_version),
            profile_id,
            archive_vector_id,
    ...
    pub fn current_vector_generation(
        ...
        self.vector_generations.current_generation(profile_id)
    }
    ...
    pub fn vector_generation_at(
        ...
        self.vector_generations
            .generation_at(profile_id, vector_version)
    }
