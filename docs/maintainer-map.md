...
| Memories / revision authority / provenance / temporal status | [Architecture](architecture.md), [Storage format](storage-format.md), [Rust API](api.md), [Architectural invariants](invariants.md), [ADR 0012](decisions/0012-deterministic-episodes-and-insomnia-memory-authority.md), [ADR 0020](decisions/0020-reliquary-and-phylactery-file-kinds.md) | `src/memory_*.rs`, `src/cva_memory_publish.rs`, `src/cva.rs`, `src/phylactery.rs` | `src/memory_tests.rs`, `src/memory_codec_tests.rs`, `src/phylactery_tests.rs` |
