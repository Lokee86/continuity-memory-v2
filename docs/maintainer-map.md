...
| Derived Graph communities / Leiden baseline | [Architecture](architecture.md), [Storage format](storage-format.md), [Rust API](api.md), [ADR 0025](decisions/0025-owner-local-derived-communities.md) | `src/community_*.rs`, `src/cva_communities.rs`, `src/phylactery_communities.rs` | `src/community_tests.rs` |
