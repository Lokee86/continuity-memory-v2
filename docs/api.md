...
Community IDs identify exact owner-scoped membership, not continuity across changed membership. Split/merge lineage and incremental changed-region invalidation are not part of this API yet. Human-readable names are intentionally absent; Warlock may overlay editable display names without changing Reliquary state semantics.
