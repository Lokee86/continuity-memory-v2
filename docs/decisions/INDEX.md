...
- [ADR 0035: Chronos shared temporal semantics](0035-chronos-shared-temporal-semantics.md) — **Accepted; deterministic core/grammar and resolution status implemented; Insomnia prepared-Memory assessment integration started; bounded inference, inferred persistence/staleness, and Perception integration remain future work**, 2026-09-09.
