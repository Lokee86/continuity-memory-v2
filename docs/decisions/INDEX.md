...
- [ADR 0036: Typed semantic Graph endpoints over Arcana](0036-typed-semantic-graph-endpoints.md) — **Accepted; typed node identity/catalogue, durable Entity owner, and persisted Memory→Entity EntityAssociation relations implemented; resolver/bootstrap integration remains Milestone B work**, 2026-09-17.
