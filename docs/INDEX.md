...
- [Dream implementation plan](dream-implementation-plan.md) — pair-oriented Dream redesign, implemented Milestones A/B/C/D/E/F candidate retrieval through first lifecycle-complete end-to-end processing, plus deterministic temporal, canonical-policy, and remaining staged work.
