...
- [Chronos subsystem plan](chronos-subsystem-plan.md) — shared temporal architecture and implementation status: deterministic core/coverage plus unresolved-only verified inference and Insomnia Memory persistence are implemented; detector calibration and Perception integration continue incrementally.
