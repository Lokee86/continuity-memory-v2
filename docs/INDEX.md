...
- [Dream implementation plan](dream-implementation-plan.md) — pair-oriented Dream redesign, implemented Milestones A/B/C candidate retrieval, pair classification, and independent verification, indexed duplicate chain, temporal determinism, lifecycle, and remaining staged implementation plan.
