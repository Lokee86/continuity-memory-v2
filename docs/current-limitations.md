...
- General format migration is not implemented. The Graph owner is a narrow compatibility exception: pre-Graph CVAs reopen with empty Graph state and write the Graph format marker lazily on the first graph mutation.
