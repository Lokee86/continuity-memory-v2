...
95. **Community names cannot become Graph authority.** Dream-generated and user-authored names are clock-neutral metadata keyed to exact `CommunityId`; neither can change membership, Graph authority, traversal, identity, or semantic clocks. For one exact Community ID, explicit user naming takes precedence over Dream generation.
