...
81. **Shared codecs do not collapse file semantics.** Phylactery currently persists Memories, Entities, Graph, Packed Vectors, Memory Vectors, Compatibility Profiles, and PHY-owned Ego state; REL-only owners cannot appear in PHY merely because the shared container can physically carry their bytes.
