...
| `src/master_key*.rs` | 256-bit master-key generation, temporary JSON persistence, redaction, tests | [Local configuration](configuration.md), [Rust API](api.md), [Current limitations](current-limitations.md) |
