...
| `src/archive*.rs` | Archive source-history ownership, nodes, branches, dual Archive/global publication metadata, reopen/indexing | [Architecture](architecture.md), [Storage format](storage-format.md), [Rust API](api.md), [ADR 0003](decisions/0003-layered-version-clocks-and-local-ancestry.md) |
