...
| Divergent CVA reconciliation replays Archive source state, Episodes, Memory revisions, durable Insomnia completions, and file-to-Memory links; grouped completions are re-ticketed, identical receipts deduplicate, and incompatible Branch/Memory/completion revisions fail closed | `cva_reconcile_merge_tests::*`, `cva_reconcile_memory_tests::*`, `cva_reconcile_grouped_tests::reconcile_replays_grouped_insomnia_memory_records`, `cva_reconcile_link_tests::reconcile_replays_file_memory_links_after_targets`, `cva_reconcile_guard_tests::*` |
